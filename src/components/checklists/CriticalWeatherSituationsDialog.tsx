...
interface CriticalWeatherSituationsDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
const CriticalWeatherSituationsDialog: React.FC<CriticalWeatherSituationsDialogProps> = ({
  isOpen,
  onClose,
  onSave,
  initialValues
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            <Label htmlFor="weather-training-date">Date of Completion</Label>
            <DateSelector
              date={date}
...
export default CriticalWeatherSituationsDialog;
