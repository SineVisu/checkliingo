...
interface WeightBalanceComputationsDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
const WeightBalanceComputationsDialog: React.FC<WeightBalanceComputationsDialogProps> = ({
  isOpen,
  onClose,
  onSave,
  initialValues
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            <Label htmlFor="weight-balance-training-date">Date of Completion</Label>
            <DateSelector
              date={date}
...
export default WeightBalanceComputationsDialog;
