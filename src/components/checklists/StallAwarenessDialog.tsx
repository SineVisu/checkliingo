...
interface StallAwarenessDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
const StallAwarenessDialog: React.FC<StallAwarenessDialogProps> = ({
  isOpen,
  onClose,
  onSave,
  initialValues
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Stall Awareness Ground Training</DialogTitle>
          <DialogDescription>
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            <Label htmlFor="stall-training-date">Date of Completion</Label>
            <DateSelector
              date={date}
...
export default StallAwarenessDialog;
