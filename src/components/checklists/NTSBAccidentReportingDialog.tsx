...
interface NTSBAccidentReportingDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
const NTSBAccidentReportingDialog: React.FC<NTSBAccidentReportingDialogProps> = ({
  isOpen,
  onClose,
  onSave,
  initialValues
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            <Label htmlFor="ntsb-training-date">Date of Completion</Label>
            <DateSelector
              date={date}
...
export default NTSBAccidentReportingDialog;
