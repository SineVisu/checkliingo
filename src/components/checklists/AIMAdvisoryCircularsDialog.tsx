...
interface AIMAdvisoryCircularsDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
const AIMAdvisoryCircularsDialog: React.FC<AIMAdvisoryCircularsDialogProps> = ({
  isOpen,
  onClose,
  onSave,
  initialValues
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            <Label htmlFor="aim-training-date">Date of Completion</Label>
            <DateSelector
              date={date}
...
export default AIMAdvisoryCircularsDialog;
