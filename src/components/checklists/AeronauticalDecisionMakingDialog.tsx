...
interface AeronauticalDecisionMakingDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
const AeronauticalDecisionMakingDialog: React.FC<AeronauticalDecisionMakingDialogProps> = ({
  isOpen,
  onClose,
  onSave,
  initialValues
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            <Label htmlFor="adm-training-date">Date of Completion</Label>
            <DateSelector
              date={date}
...
export default AeronauticalDecisionMakingDialog;
